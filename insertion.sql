...
INSERT INTO instalment_pay (payment_id, installment_id, payment_date, payment_due_date,  installment_number, max_installments, required_payment, customer_paid_amount, payment_status) values (10, 10, '2022-09-28', '2023-02-14', 6, 9, 186, 153, 'PAID FULL');
INSERT INTO instalment_pay (payment_id, installment_id, payment_date, payment_due_date,  installment_number, max_installments, required_payment, customer_paid_amount, payment_status) values (2, 1, '2022-11-04', '2022-08-09', 8, 12, 167, 155, 'PAID INSTALMENT');
INSERT INTO instalment_pay (payment_id, installment_id, payment_date, payment_due_date,  installment_number, max_installments, required_payment, customer_paid_amount, payment_status) values (9, 1, '2022-10-16', '2023-02-11', 2, 4, 160, 159, 'PAID FULL');
INSERT INTO instalment_pay (payment_id, installment_id, payment_date, payment_due_date,  installment_number, max_installments, required_payment, customer_paid_amount, payment_status) values (8, 4, '2022-09-27', '2022-10-16', 3, 3, 171, 192, 'PAID INSTALMENT');
INSERT INTO instalment_pay (payment_id, installment_id, payment_date, payment_due_date,  installment_number, max_installments, required_payment, customer_paid_amount, payment_status) values (4, 5, '2022-11-02', '2022-10-14', 4, 6, 197, 186, 'PAID FULL');
INSERT INTO instalment_pay (payment_id, installment_id, payment_date, payment_due_date,  installment_number, max_installments, required_payment, customer_paid_amount, payment_status) values (2, 3, '2022-08-30', '2023-02-09', 3, 9, 181, 166, 'PAID INSTALMENT');
INSERT INTO instalment_pay (payment_id, installment_id, payment_date, payment_due_date,  installment_number, max_installments, required_payment, customer_paid_amount, payment_status) values (8, 3, '2022-12-03', '2022-08-22', 3, 12, 169, 151, 'PAID FULL');
INSERT INTO instalment_pay (payment_id, installment_id, payment_date, payment_due_date,  installment_number, max_installments, required_payment, customer_paid_amount, payment_status) values (1, 5, '2022-06-03', '2023-02-08', 1, 1, 186, 154, 'PAID INSTALMENT');

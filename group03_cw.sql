...
--QUERIES
    ...
    SELECT DISTINCT cust_fname AS "Customer First Name", 
    ...
    --Q4)Find the first name, last name, gender and date of birth of travellers travelling with ‘Norri Veltmann’. Also add customer's full name
